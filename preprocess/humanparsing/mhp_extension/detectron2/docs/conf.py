...
try:
    ...
    for m in [
        ...
        "torch.autograd.function", "torch.nn.modules", "torch.nn.modules.utils_ootd", "torch.utils_ootd", "torch.utils_ootd.data", "torch.onnx",
...
for m in [
    ...
    "caffe2", "caffe2.proto", "caffe2.python", "caffe2.python.utils_ootd", "caffe2.python.onnx", "caffe2.python.onnx.backend",
]:
    sys.modules[m] = mock.Mock(name=m)
# fmt: on
